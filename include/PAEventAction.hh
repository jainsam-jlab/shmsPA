...
public:
    ...
    /*
     * PATrackingAction calls this when the generated primary finishes.
     *
     * The values remain stored until EndOfEventAction() writes the one PA row.
     */
    void SetPrimarySummary(G4int pdg,
                           G4bool reachedCal,
                           G4bool exitedCal)
    {
        PrimaryPDG = pdg;
...
private:
    ...
    /*
     * Event-level generated-primary truth.
     *
     * These are reset at the start of every event and filled when the
     * generated primary finishes transport.
     */
    G4int PrimaryPDG;
